...
<main class="bg-light">
    <div class="p-2">
        ...
        <nav class="px-3 py-2 bg-white rounded shadow-sm">
            ...
            <h5 class="fw-bold mb-0 me-auto" id="head">MDS</h5>
        ...
        <div class="py-4 mt-5">
            ...
            {{-- <div class="d-flex justify-content-end mb-3 mx-5">
                <a href="{{ url('admin/mds/add') }}" id="acic_add_new_record" class="btn add_record_button" type="button"> Add new MDS record</a>
            </div> --}}
