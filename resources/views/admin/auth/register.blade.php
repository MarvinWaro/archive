        ...
        <div class="card p-4 shadow-lg px-4 custom-card" style="width: 100%; max-width: 470px; border-radius: 30px; padding: 25px 40px !important">
            ...
            <form action="#">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control input-custom" id="name" placeholder="testuser123" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="password" class="form-label text-black label-custom">Confirm Password</label>
                    <input type="password" class="form-control input-custom" id="password" placeholder="**********" required>
                </div>
                <div class="d-grid">
