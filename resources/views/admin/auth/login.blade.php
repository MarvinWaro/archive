...
@section('content')
    ...
    <div class="d-flex justify-content-center align-items-center vh-100 ched-img-bg">
        <div class="card p-4 shadow-lg px-4" style="width: 100%; max-width: 470px; border-radius: 30px; padding: 25px 40px !important">
            <!-- Logo Section -->
            ...
            <form action="#">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <p class="text-center mt-3"><a href="#" class="login-link">Forgot Password</a></p>
                    <p class="text-center mt-3"><a href="#" class="login-link">Register here</a></p>
                </div>
